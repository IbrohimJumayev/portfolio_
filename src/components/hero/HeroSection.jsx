...
const HeroSection = () => {
  return (
    <div id="#" className="mt-32 max-md:mt-24 flex items-center max-md:flex-col gap-5">
      <div className="flex-[2] max-lg:flex-1 max-md:text-center">
        ...
        <div className="flex gap-5 mt-8 max-md:justify-center max-sm:flex-col">
          ...
          <button className="px-6 py-2 border rounded-full text-blueLight font-semibold border-blueLight hover:bg-blueLight hover:text-white duration-300">
            Download CV
          </button>
        </div>
      </div>
